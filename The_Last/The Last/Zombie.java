...
public class Zombie extends Actor
{
    ...
    private final int ANIMATION_DELAY = 12; 

    public Zombie()
    {
        
        walkingFrames = new GreenfootImage[3];
        walkingFrames[0] = new GreenfootImage("ZombieLeft.png");
        walkingFrames[1] = new GreenfootImage("Zombie.png");
        walkingFrames[2] = new GreenfootImage("ZombieRight.png");
